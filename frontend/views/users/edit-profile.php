                        ...
                        <div class="row mt-20">
                            <?php $form = ActiveForm::begin([
                                ...
                                <div class="col-lg-12 col-xs-12">
                                   <?= $form->field($userM, 'email')->input('email', ['disabled' => 'disabled'])->label('Email'); ?>
                                </div>
                                <div class="col-lg-12 col-xs-12">
                                   <?= $form->field($userM, 'mobile_no')->textInput(['disabled' => 'disabled'])->label('Phone'); ?>
                                </div>
                                <div class="col-lg-12 col-xs-12">
                                   <?= $form->field($userM, 'name')->textInput()->label('Name'); ?>
                                </div>
                                <div class="col-lg-12 col-xs-12">
                                   <?= $form->field($userM, 'city')->textInput()->label('City'); ?>
                                </div>
                                <div class="col-lg-12 col-xs-12">
                                   <?= $form->field($userM, 'address')->textarea()->label('Address'); ?>
                                </div>
                                <div class="col-lg-12">
